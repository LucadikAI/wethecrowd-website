  ...
  return (
    <div className="flex overflow-hidden whitespace-nowrap py-1">
      <motion.div 
        ...
        className="flex text-[12vw] md:text-[9vw] font-bold uppercase tracking-tighter text-gray-900 leading-none"
      >
...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-white">
      {/* Marquee - perfectly centered in viewport */}
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex flex-col py-4">
      ...
      {/* Description & Buttons Block - pinned to bottom */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.5 }}
        className="absolute bottom-0 inset-x-0 pb-16 flex flex-col items-center text-center px-6"
      >
