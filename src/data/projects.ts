...
export const projects: Project[] = [
  {
    ...
    impact: "Een onvergetelijke dag in Rotterdam Ahoy waar 15.000 jongeren samenkomen voor optredens van artiesten als Typhoon, Lecrae, Elevation Rhythm, Marc Floor, Rend Collective en Pjotr.",
