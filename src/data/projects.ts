...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Als producer voor de DiscoverEU Learning Cycle organiseren we meet-ups voor Europese jongeren die een interrail pas hebben gewonnen. Het doel is om een community-gevoel te creëren en reizigers te inspireren. Buiten de meet-ups is er ook elk jaar een kick-off en afterparty voor de Nederlandse reizigers. Ik ben verantwoordelijk voor de volledige logistieke planning, afstemming met locaties, programmering en on-site coördinatie van deze evenementen.",
  ...
  },
  {
    ...
    title: "The Paper Kites — Tourcoördinatie",
    role: "Tourcoördinator",
    client: "410 MGMT Co.",
    impact: "Volledige tourcoördinatie voor de Australische indie-folk band The Paper Kites tijdens hun bezoek aan Amsterdam.",
    description: "Toen ik last minute een bericht kreeg met de vraag of iemand het transport van de Australische band The Paper Kites kon regelen, was dat uiteraard geen probleem. WE THE CROWD schakelde direct een chauffeur en busje in, en verzorgde gedurende de afgelopen twee dagen ook de volledige communicatie en afstemming met de tourmanager. Zo werden alle apparatuur en bagage soepel vervoerd tussen het hotel, de venue en het vliegveld en kon The Paper Kites zich focussen op een gave show in Amsterdam.",
